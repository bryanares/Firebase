package com.example.firebaseathentication.features.auth.domain.viewmodel
...
import com.example.firebaseathentication.features.auth.domain.model.AuthUiState
